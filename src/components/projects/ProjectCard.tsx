  ...
  return (
    <li className="rounded-xl border border-[hsl(var(--border))] p-5 bg-[hsl(var(--card))] flex flex-col gap-3">
      <div className="flex flex-wrap gap-2 items-center">
        {project.highlight && (
          <span
            className={`text-[10px] px-2 py-0.5 rounded-full font-semibold uppercase tracking-wide ${project.highlight.colorClass}`}
          >
      ...
      <div className="mt-auto flex items-center gap-4 text-[11px] text-[hsl(var(--color-muted))]">
        ...
        <a
          ...
          className="text-[hsl(var(--primary))] hover:underline ml-auto"
        >
          GitHub ↗
        </a>
      </div>
